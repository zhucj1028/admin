...
public class JwtUtils {
    ...
    public static CheckResult validateJWT(String jwtStr) {
        ...
        try {
            ...
            checkResult.setErrCode(ConstantUtils.JWT_ERRCODE_EXPIRE);
            checkResult.setSuccess(false);
        } catch (SignatureException e) {
            checkResult.setErrCode(ConstantUtils.JWT_ERRCODE_FAIL);
            checkResult.setSuccess(false);
        } catch (Exception e) {
            checkResult.setErrCode(ConstantUtils.JWT_ERRCODE_FAIL);
            checkResult.setSuccess(false);
    ...
    public static SecretKey generalKey() {
        byte[] encodedKey = Base64.decode(ConstantUtils.JWT_SECERT);
